...
const Intro = ({ theme }) => {
  ...
  return (
    <div className={`${theme}theme w-full h-[75vh] flex justify-around items-center`}>
      <div className="left ml-6 border-2 rounded-[20px] border-[#6a5989]">
        <div className={`w-[40vw] h-[360px] rounded-[17px] p-4 raleway transition-all duration-300 ${
        ...
        <div className="right perspective">
        <div className="flip-card">
        <div className="flip-card-inner">
          <div className="flip-card-front">
            <img src={gitpic} alt="Image Front" className="w-[100px] rounded-[50%] border-[#6a5989] border-2 shadow-custom ml-6" />
          </div>
          <div className="flip-card-back">
            <img src={mypic} alt="Image Back" className="w-[100px] rounded-[50%] border-[#6a5989] border-2 shadow-custom ml-6" />
          </div>
        </div>
      </div>
</div>
