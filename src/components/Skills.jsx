    ...
    <section className="relative flex flex-col items-center gap-6 px-4 py-16">
      ...
      {skills.map((skill, index) => (
        <div
          ...
          className="w-full max-w-4xl h-[125px] flex items-center bg-white rounded-xl shadow-lg p-4 transform translate-x-full opacity-0 transition-all duration-700 ease-out"
        >
          <div className="w-12 text-[#7E6EAA] font-bold text-sm mt-10 transform -rotate-90 origin-left whitespace-nowrap flex items-center justify-center raleway text-[20px]">
            {skill.title}
          </div>

          <div className="flex-1 flex flex-wrap items-center gap-4 ml-4">
